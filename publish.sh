...
aws s3 cp ./onset-pricing-kor.html s3://75mm.studio --acl public-read --profile 75mm.studio
aws s3 cp ./js/onset-pricing-eng.js s3://75mm.studio/js/ --acl public-read --profile 75mm.studio
aws s3 cp ./js/onset-pricing-kor.js s3://75mm.studio/js/ --acl public-read --profile 75mm.studio
